...
So we took a different approach. We built a modern frontend layer underneath the existing UI and styled it to look identical to what was already there. Same colors, same spacing, same elements. Product teams could use it without fighting the old infrastructure. Customers never noticed anything had changed. That was the point. The first years were about earning a foothold within the software, without triggering resistance.
