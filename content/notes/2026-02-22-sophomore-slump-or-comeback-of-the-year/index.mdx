...
Learning to live with that, to keep moving anyway, takes a certain kind of stubbornness. At some point the discomfort stops feeling like something to fix and starts feeling like the work. The alternative is to wait for certainty that was never coming.
