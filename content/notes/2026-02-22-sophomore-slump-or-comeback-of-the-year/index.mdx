...
As it turned out, the business had started asking the same questions we had been quietly sitting on. They had arrived at the same place, just from a different direction. We would have made the move eventually regardless. That kind of alignment doesn't happen often. When it does, you act.
...
This is what the work of a design system team looked like for us in a mid-sized company. The components and the documentation are the part you can easily show, the part people usually picture when they hear "design system." Everything else, the rooms and conversations, is also the work. This is where the hours went. This is where the value came from. It's the shape of the work that rarely gets talked about. It's also what design system teams have to grow into to do their work well.

What we learned was that you can't think your way past inertia. You have to move through it. Every small change we shipped was a conscious act against it, and also a source of information we couldn't have gotten any other way. You don't know what the system will tolerate until you touch it. You don't know what users actually need until something breaks.
