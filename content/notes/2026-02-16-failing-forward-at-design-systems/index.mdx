...
description: Building a design system for a 20-year-old product looked like a tidy problem on paper. Components, tokens, documentation. Every assumption I had fell apart along the way, and I slowly learned to stop confusing the map for the territory.
