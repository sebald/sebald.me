...
When you build a design system inside a legacy product, you might think the work is about how the product looks and behaves. Most of it isn't. It's hard to recognize that work for what it is, especially when you're the one doing it.

For us, the visible signs were strong. The codebase had finally stopped resisting change. Features that used to take months were now taking weeks. The visual refresh held up too, with a small customer survey coming back strongly positive. That part of the work felt good in a way that was easy to measure.

But that was the smallest part. The work was everything that had to happen before any of that could exist. Calls with executives who needed to understand why the product was changing. Sessions with sales teams whose demos were being pulled out from under them. Conversations with colleagues who knew the history, asking them about decisions that lived nowhere in the documentation. Edge cases added years ago for a specific customer. Behaviors that looked like bugs but were actually decisions. We would have lost all of that if we had treated this as a pure technical migration.

The components and the documentation are the part you can easily show, the part people usually picture when they hear "design system." But that's only the map. The inertia, the workflows users built inside the broken parts of the product, the trust we had to earn before anything visible could ship. That's the territory. It's what design system teams have to grow into.
