...
The components and the documentation are the part you can easily show, the part people usually picture when they hear "design system." But that's only the map. The rooms and conversations, the inertia, the workflows users built inside the broken parts of the product. Most of our hours went here, and that's where most of our value came from. It's the shape of the work that rarely gets talked about. It's also what design system teams have to grow into to do their work well.

Part of growing into the work was learning that you can't think your way past inertia. You have to move through it. Every small change we shipped was a conscious act against it, and also a source of information we couldn't have gotten any other way. You don't know what the system will tolerate until you touch it. In a product this old, you don't know what users actually need until something breaks.
